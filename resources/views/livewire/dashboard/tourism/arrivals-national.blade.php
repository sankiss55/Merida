@section('title','Distribución de Pasajeros Llegadas Nacionales')
<section class="h-full overflow-y-auto p-2">
    <div class="w-full h-full flex flex-wrap md:flex-nowrap space-y-2 md:space-y-0 md:space-x-2">
        <div class="order-2 md:order-1 w-full md:w-2/3 h-[60vh] md:h-full  bg-white rounded-lg shadow p-2 flex items-center justify-center"  wire:ignore>
            <canvas id="chartOrigin"  style="width: 100%; height: 100%;" ></canvas>
        </div>
            ...
            <div class="w-full flex flex-wrap">
                <div class="w-full p-2 text-base md:text-lg xl:text-xl text-center bg-white rounded-lg shadow" wire:ignore>
                    <ul class="text-center">
                        <li class="font-bold text-red-500 uppercase">Llegadas Nacionales</li>
    ...
    <script>
        ...
        function drawChartOrigin(){
            ...
            ConfigPie.options.plugins.title.text='LLEGADAS NACIONALES ';
