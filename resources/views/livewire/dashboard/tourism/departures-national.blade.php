@section('title','Distribución de Pasajeros Salidas Nacionales')
<section class="w-full h-full overflow-y-auto p-2">
    <div class="w-full h-full flex flex-wrap md:flex-nowrap space-y-2 md:space-y-0 md:space-x-2">
        <div class="order-2 md:order-1 w-full md:w-2/3 h-[50vh] md:h-full p-2 bg-white rounded-lg shadow flex items-center justify-center"  wire:ignore>
        ...
        <div class="order-1 md:order-2 w-full md:w-1/3 flex flex-wrap">
            <div  class="w-full p-2 text-base md:text-lg xl:text-xl  text-center bg-white rounded-lg shadow" wire:ignore>
                <ul class="text-center">
                    <li class="font-bold text-red-500">Salidas Nacionales</li>
            ...
            <div class="w-full  text-center uppercase">
                <div class="w-full flex flex-wrap">
                    ...
                    <div class="w-full rounded-lg overflow-x-auto h-[20vh] md:h-full  p-2 shadow-inner md:shadow-none flex items-center justify-center">
    ...
    <script>
        ...
        async function getDepartures(){
            let body = {'national':true,'start':date_start,'end':date_end};
        ...
        function drawChartDepartures(){
            ...
            ConfigPie.options.plugins.title.text='SALIDAS NACIONALES ';
